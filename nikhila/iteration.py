player1=3
#for a in range(1,11):
print(*range(100,90,-1),sep='      ')
print(*range(81,91),sep='      ')
print(*range(80,70,-1),sep='      ')
print(*range(61,71),sep='      ')
print(*range(60,50,-1),sep='      ')
print(*range(41,51),sep='      ')
print(*range(40,30,-1),sep='      ')
print(*range(21,31),sep='      ')
print(*range(20,10,-1),sep='      ')
x=3
for p in range(1,10):
    if(x==p):
        print("p1")
