                ...
                $(".lm").click(function(){
                    ...
                    for(k in result)
                    {
                        ...
                        for(var j=0; j<result[i].videos.length ;j++){
                            $("#con").append('<div id="menu'i'" ><p><b>episode title</p></b><p>'+result[i].videos[j].episode_title+'</p>'
                                +'<p><b>season</p></b><p>'+result[i].videos[j].season+'</p>'
                                +'<p><b>ratings</p></b><p>'+result[i].videos[j].ratings+'</p>'
                                +'<p><b>thumbnail</p></b><p>'+result[i].videos[j].video_thumbnail+'</p></div><br>');
                        }
